...
<head>
    ...
    <title>Data Pengguna - Sistem Prestasi</title>
...
<body class="bg-gradient-to-br from-school-light-green to-white min-h-screen">
    ...
    <div id="sidebar"
        ...
        <nav class="p-4 space-y-2">
            ...
            <a href="<?= base_url('users') ?>" class="nav-item flex items-center gap-3 p-3 rounded-lg bg-school-light-green text-school-dark-green transition-all duration-200 group">
    ...
    <div class="md:ml-64 min-h-screen">
        ...
        <header class="bg-white shadow-md flex items-center justify-between px-4 h-16 sticky top-0 z-40 backdrop-blur-lg bg-opacity-95">
            ...
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-xl font-semibold text-gray-800 hidden sm:block">Data Pengguna</h2>
            </div>
