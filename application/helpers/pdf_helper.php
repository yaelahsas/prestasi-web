...
if (!function_exists('generate_pdf_footer')) {
    ...
    function generate_pdf_footer($pdf, $location = '', $date = '') {
        ...
        if ($sekolah) {
            ...
            if ($location) {
                $html .= '<p style="margin: 5px 0;">' . $location . '</p>';
            }
            if ($date) {
                $html .= '<p style="margin: 5px 0;">' . $date . '</p>';
            }
            $html .= '</td>';
            
            // Right side - Principal signature
            $html .= '<td style="width: 60%; text-align: right; vertical-align: top;">';
            $html .= '<p style="margin: 5px 0;">Mengetahui,</p>';
            $html .= '<p style="margin: 5px 0;">Kepala Sekolah</p>';
            $html .= '<p style="margin: 30px 0 5px 0;">' . $sekolah['kepala_sekolah'] . '</p>';
